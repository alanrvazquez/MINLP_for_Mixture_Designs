...
ord_x(np)           'ordering of the proportions in the ingredients'
...
* problem
model COMMON /vec_fim1, vec_fim2, vec_fim3, vec_fim4, vec_fim5, vec_fim6, ord_x,
              mat_fim, eq_l, eq_u1, chol_sta, ing_avail, ord_nw, symm_fim,
